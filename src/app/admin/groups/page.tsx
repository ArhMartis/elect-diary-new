    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 p-3 md:p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-2 md:gap-4 mb-6 flex-wrap">
          <Link
            href="/admin"
            className="inline-flex items-center gap-2 px-3 md:px-5 py-2 md:py-3 bg-white border-2 border-blue-200 text-blue-700 rounded-xl hover:bg-blue-50 hover:border-blue-300 transition-all shadow-md hover:shadow-lg font-medium text-sm md:text-base"
          >
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">🎓 Классы</h1>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border-2 border-blue-200 p-4 md:p-6">
          ...
          <form action={createGroup} className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-end">
      ...
      {/* Плавающая кнопка Назад — только для ПК */}
      <Link
        href="/admin"
        className="hidden md:inline-flex fixed bottom-6 right-6 z-40 items-center gap-2 px-5 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-xl shadow-xl hover:from-indigo-700 hover:to-purple-700 hover:shadow-2xl hover:scale-105 transition-all"
      >
