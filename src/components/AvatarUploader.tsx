      ...
      <div className="flex items-center gap-3 shrink-0">
        <div className="relative">
          <img
            ...
            className={`w-16 h-16 rounded-full object-cover border-2 border-white shadow-md ${isCustomAvatar ? "cursor-pointer hover:opacity-90 transition-opacity" : ""}`}
            onClick={() => isCustomAvatar && setShowModal(true)}
          />
          {isCustomAvatar && (
            <div className="absolute inset-0 rounded-full bg-black/0 hover:bg-black/20 transition-colors flex items-center justify-center pointer-events-none">
              <svg
